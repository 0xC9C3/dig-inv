...
func (tc *TagCreate) SetDeletedBy(s string) *TagCreate {
	tc.mutation.SetDeletedBy(s)
	return tc
}

// SetNillableDeletedBy sets the "deleted_by" field if the given value is not nil.
func (tc *TagCreate) SetNillableDeletedBy(s *string) *TagCreate {
	if s != nil {
		tc.SetDeletedBy(*s)
	}
	return tc
...
func (tc *TagCreate) AddItemIDs(ids ...uuid.UUID) *TagCreate {
...
func (tc *TagCreate) check() error {
	...
	if _, ok := tc.mutation.UpdatedBy(); !ok {
		return &ValidationError{Name: "updated_by", err: errors.New(`ent: missing required field "Tag.updated_by"`)}
	}
	if _, ok := tc.mutation.UpdatedAt(); !ok {
