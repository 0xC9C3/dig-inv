...
func (tu *TagUpdate) SetNillableCreatedBy(s *string) *TagUpdate {
	if s != nil {
		tu.SetCreatedBy(*s)
	}
	return tu
...
func (tu *TagUpdate) SetNillableUpdatedBy(s *string) *TagUpdate {
	if s != nil {
		tu.SetUpdatedBy(*s)
	}
	return tu
...
func (tu *TagUpdate) SetDeletedBy(s string) *TagUpdate {
	tu.mutation.SetDeletedBy(s)
	return tu
}

// SetNillableDeletedBy sets the "deleted_by" field if the given value is not nil.
func (tu *TagUpdate) SetNillableDeletedBy(s *string) *TagUpdate {
	if s != nil {
		tu.SetDeletedBy(*s)
	}
	return tu
...
func (tu *TagUpdate) ClearDeletedBy() *TagUpdate {
...
func (tu *TagUpdate) AddItemIDs(ids ...uuid.UUID) *TagUpdate {
...
func (tu *TagUpdate) RemoveItemIDs(ids ...uuid.UUID) *TagUpdate {
...
func (tu *TagUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := tu.mutation.CreatedBy(); ok {
		_spec.SetField(tag.FieldCreatedBy, field.TypeString, value)
	}
	if value, ok := tu.mutation.UpdatedBy(); ok {
		_spec.SetField(tag.FieldUpdatedBy, field.TypeString, value)
	}
	if value, ok := tu.mutation.UpdatedAt(); ok {
		_spec.SetField(tag.FieldUpdatedAt, field.TypeTime, value)
	}
	if value, ok := tu.mutation.DeletedBy(); ok {
		_spec.SetField(tag.FieldDeletedBy, field.TypeString, value)
	}
	if tu.mutation.DeletedByCleared() {
		_spec.ClearField(tag.FieldDeletedBy, field.TypeString)
	}
	...
	if tu.mutation.ItemsCleared() {
		edge := &sqlgraph.EdgeSpec{
			...
			Columns: []string{tag.ItemsColumn},
			Bidi:    false,
...
// SetNillableCreatedBy sets the "created_by" field if the given value is not nil.
func (tuo *TagUpdateOne) SetNillableCreatedBy(s *string) *TagUpdateOne {
	if s != nil {
		tuo.SetCreatedBy(*s)
	}
	return tuo
...
// SetNillableUpdatedBy sets the "updated_by" field if the given value is not nil.
func (tuo *TagUpdateOne) SetNillableUpdatedBy(s *string) *TagUpdateOne {
	if s != nil {
		tuo.SetUpdatedBy(*s)
	}
	return tuo
...
// SetDeletedBy sets the "deleted_by" field.
func (tuo *TagUpdateOne) SetDeletedBy(s string) *TagUpdateOne {
	tuo.mutation.SetDeletedBy(s)
	return tuo
}

// SetNillableDeletedBy sets the "deleted_by" field if the given value is not nil.
func (tuo *TagUpdateOne) SetNillableDeletedBy(s *string) *TagUpdateOne {
	if s != nil {
		tuo.SetDeletedBy(*s)
	}
	return tuo
...
// ClearDeletedBy clears the value of the "deleted_by" field.
func (tuo *TagUpdateOne) ClearDeletedBy() *TagUpdateOne {
...
// AddItemIDs adds the "items" edge to the Item entity by IDs.
func (tuo *TagUpdateOne) AddItemIDs(ids ...uuid.UUID) *TagUpdateOne {
...
// RemoveItemIDs removes the "items" edge to Item entities by IDs.
func (tuo *TagUpdateOne) RemoveItemIDs(ids ...uuid.UUID) *TagUpdateOne {
