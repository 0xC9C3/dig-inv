...
func (ic *ItemCreate) SetCreatedBy(s string) *ItemCreate {
...
func (ic *ItemCreate) SetUpdatedBy(s string) *ItemCreate {
...
func (ic *ItemCreate) SetDeletedBy(s string) *ItemCreate {
	ic.mutation.SetDeletedBy(s)
	return ic
}

// SetNillableDeletedBy sets the "deleted_by" field if the given value is not nil.
func (ic *ItemCreate) SetNillableDeletedBy(s *string) *ItemCreate {
	if s != nil {
		ic.SetDeletedBy(*s)
	}
	return ic
...
func (ic *ItemCreate) AddTagIDs(ids ...uuid.UUID) *ItemCreate {
...
func (ic *ItemCreate) check() error {
	...
	if _, ok := ic.mutation.UpdatedBy(); !ok {
		return &ValidationError{Name: "updated_by", err: errors.New(`ent: missing required field "Item.updated_by"`)}
	}
	if _, ok := ic.mutation.UpdatedAt(); !ok {
